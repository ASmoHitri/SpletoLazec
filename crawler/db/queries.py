q = {
    'get_url_id_from_frontier': "SELECT page_id FROM crawldb.frontier ORDER BY timestamp LIMIT 1",
    ...
    'update_frontier_page_occ': "UPDATE crawldb.frontier SET occupied=True"
}
